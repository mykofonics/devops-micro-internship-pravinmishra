...
![alt text](<screenshots/Screenshot_1_assig_3_1.png>)

#### Screenshot 2 — Active Sprint board showing the Sprint Goal

![alt text](<screenshots/Screenshot_2_assig_3_1.png>)
...
![alt text](<screenshots/Screenshot_7_assig_3_3.png>)
...
![alt text](<screenshots/Screenshot_9_assig_3_3.png>)

#### Screenshot 10 — Jira Story comment showing the Day 2 Daily Scrum update

![alt text](<screenshots/Screenshot_10_assig_3_3.png>)
...
![alt text](<screenshots/Screenshot_11_assig_3_4.png>)

#### Screenshot 12 — Mobile responsive view showing the footer remains readable

![alt text](<screenshots/Screenshot_12_assig_3_4.png>)

#### Screenshot 13 — Jira Story comment showing the Day 3 Daily Scrum update

![alt text](<screenshots/Screenshot_13_assig_3_4.png>)
...
![alt text](<screenshots/Screenshot_15_assig_3_6.png>)

#### Screenshot 16 — Jira retrospective comment

![alt text](<screenshots/Screenshot_16_assig_3_6.png>)

#### Screenshot 17 — Final EC2 browser view showing the complete footer requirement

![alt text](<screenshots/Screenshot_17_assig_3_6.png>)

![alt text](<screenshots/Screenshot_last_assig_3.png>)

#### Demo Video URL

Paste your unlisted YouTube or accessible Google Drive demo-video link here:

https://drive.google.com/file/d/1kcmUDpwJ1NmIjG34fVcnz_NKVEOc1_DF/view?usp=sharing
